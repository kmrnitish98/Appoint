...
export function Dashboard(){
    ...
    return(
        <div className="container p-4 justify-content-center align-items-center">
            <div className=" w-full sm:w-2/3 md:w-2/4 lg:w-1/2 p-3 mt-6 bg-amber-100 shadow-xl/40 rounded-4 mx-auto">
            <span className="d-flex justify-content-between align-items-center bg-amber-200 p-2 rounded-4 md:text-xl w-100 mb-3">
                <span className="bi bi-person-circle fw-bold text-amber-800 text-sm"> Welcome,{cookies['username']}</span>
                <span className="text-amber-600 fw-bold">Dashboard</span>
